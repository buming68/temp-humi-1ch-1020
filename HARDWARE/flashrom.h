...
extern u8 dipkey_init(void);							//初始化功能设置 dip开关，位7---19200/9600  位6、5---自动回传   位4-0：地址
extern u8 dipkey_lora_init(void); 				//初始化功能设置 LORA定义开关  位7、6--地址  位5、4--网络ID  位3--0：信道频率（23--48）
